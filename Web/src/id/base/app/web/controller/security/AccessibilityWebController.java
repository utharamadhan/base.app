package id.base.app.web.controller.security;
...
public class AccessibilityWebController {
	...
	public String save(@RequestParam(value="pkAppRole") final Long pkAppRole, @RequestParam(value="accessibilities") final String accessibilities, final ModelMap model){
		new SpecificRestCaller<UserGroupAccessNode>(RestConstant.REST_SERVICE, RestConstant.RM_ROLE_FUNCTION, UserGroupAccessNode.class).executePost(new SpecificInterfaceRestCaller() {
			@Override
