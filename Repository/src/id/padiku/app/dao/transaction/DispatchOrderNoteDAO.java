...
@Repository
public class DispatchOrderNoteDAO extends AbstractHibernateDAO<DispatchOrderNote, Long> implements IDispatchOrderNoteDAO {
	...
	public void saveOrUpdate(DispatchOrderNote anObject) throws SystemException {
		if(anObject.getPkDispatchOrderNote()!=null){
			super.update(anObject);
		}else{
			anObject.setPickingNumber(generatePickingNumber(anObject.getCompany().getPkCompany()));
	...
	public void delete(Long[] objectPKs) throws SystemException {
		for(Long objectPK : objectPKs){
			DispatchOrderNote obj = findById(objectPK);
	...
	@Override
	public List<DispatchOrderNote> findObjects(Long[] objectPKs) throws SystemException {
		return null;
	}
	...
	public DispatchOrderNote getDispatchOrderNoteById(Long maintenancePK) throws SystemException {
		Criteria crit = getSession().createCriteria(domainClass);
			...
			DispatchOrderNote grn = (DispatchOrderNote) crit.uniqueResult();
		if(null != grn) {
			grn.setDispatchOrderNoteDetails(getDispatchOrderNoteDetails(maintenancePK));
		}
		return grn;
	}
	
	public List<DispatchOrderNoteDetail> getDispatchOrderNoteDetails(Long maintenancePK) throws SystemException {
