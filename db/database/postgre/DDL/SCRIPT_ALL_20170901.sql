...
ALTER TABLE RESEARCH ADD COLUMN IS_DOWNLOAD boolean DEFAULT true;
ALTER TABLE RESEARCH ADD COLUMN DOWNLOAD_TYPE INTEGER DEFAULT 0;
ALTER TABLE RESEARCH ADD COLUMN PASSWORD TEXT;
ALTER TABLE DIGITAL_BOOK ADD COLUMN IS_DOWNLOAD boolean DEFAULT true;
ALTER TABLE DIGITAL_BOOK ADD COLUMN DOWNLOAD_TYPE INTEGER DEFAULT 0;
ALTER TABLE DIGITAL_BOOK ADD COLUMN PASSWORD TEXT;

ALTER TABLE CONTACT RENAME COLUMN fk_learning_item TO fk_program_item;