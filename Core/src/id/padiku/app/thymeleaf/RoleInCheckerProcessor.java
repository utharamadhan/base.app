...
public class RoleInCheckerProcessor extends AbstractConditionalVisibilityAttrProcessor {
	public static final int ATTR_PRECEDENCE = 0;
	public static final String ATTR_NAME = "roleIn";
	public static final String COMMA = ",";

	protected RoleInCheckerProcessor() {
		super(ATTR_NAME);
	}
